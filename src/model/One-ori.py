...
class ONE_ResNet(nn.Module):
    ...
    def __init__(self, depth, num_classes=1000):
        ...
        self.layer3_1 = self._make_layer(block, 256, n, stride=2)
        self.inplanes = fix_inplanes
        self.layer3_2 = self._make_layer(block, 256, n, stride=2)
        self.inplanes = fix_inplanes
        self.layer3_3 = self._make_layer(block, 256, n, stride=2)
